...
class Transactions1cTest : ParentIntegrationTest() {
    ...
    fun positive() {
        ...
        result.andExpect(status().isOk())
            ...
            .andExpect(jsonPath("$.statement.sender.bic").value("044525593"))
            .andExpect(jsonPath("$.statement.sender.name").value("АО \"АЛЬФА-БАНК\""))
            ...
            .andExpect(jsonPath("$.statement.recipient.inn").value("0442030587"))
            .andExpect(jsonPath("$.statement.recipient.kpp").value("018468152"))
            ...
            .andExpect(jsonPath("$.statement.data.bank.bic").value("044525593"))
            .andExpect(jsonPath("$.statement.data.bank.name").value("АО \"АЛЬФА-БАНК\""))
            ...
            .andExpect(jsonPath("$.statement.data.stamp.bic").value("044525593"))
            .andExpect(jsonPath("$.statement.data.stamp.name").value("АО \"АЛЬФА-БАНК\""))
            ...
            .andExpect(jsonPath("$.statement.data.operationInfo[0].stamp.bic").value("044525593"))
            .andExpect(jsonPath("$.statement.data.operationInfo[0].stamp.name").value("АО \"АЛЬФА-БАНК\""))
            ...
            .andExpect(jsonPath("$.statement.data.operationInfo[0].payDoc.memOrder.payer.inn").value("0442030587"))
            .andExpect(jsonPath("$.statement.data.operationInfo[0].payDoc.memOrder.payer.kpp").value("018468152"))
            .andExpect(jsonPath("$.statement.data.operationInfo[0].payDoc.memOrder.payer.account").value("40702810801300006319"))
            .andExpect(jsonPath("$.statement.data.operationInfo[0].payDoc.memOrder.payer.bank.bic").value("044525593"))
            .andExpect(jsonPath("$.statement.data.operationInfo[0].payDoc.memOrder.payer.bank.name").value("АО \"АЛЬФА-БАНК\""))
            .andExpect(jsonPath("$.statement.data.operationInfo[0].payDoc.memOrder.payee.name").value("Полное наименование Орг № 72862"))
            .andExpect(jsonPath("$.statement.data.operationInfo[0].payDoc.memOrder.payee.inn").value("0442030587"))
            .andExpect(jsonPath("$.statement.data.operationInfo[0].payDoc.memOrder.payee.kpp").value("018468152"))
            .andExpect(jsonPath("$.statement.data.operationInfo[0].payDoc.memOrder.payee.account").value("40702810901300006316"))
            .andExpect(jsonPath("$.statement.data.operationInfo[0].payDoc.memOrder.payee.bank.bic").value("044525593"))
            .andExpect(jsonPath("$.statement.data.operationInfo[0].payDoc.memOrder.payee.bank.name").value("АО \"АЛЬФА-БАНК\""))
